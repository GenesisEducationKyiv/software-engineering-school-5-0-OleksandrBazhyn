...
import { WeatherProviderManagerInterface, SubscriptionServiceInterface } from "../types.js";
...
export function createApiRoutes(
  ...
  const subscriptionController = new SubscriptionController(subscriptionService, weatherManager);
  ...
  router.get("/metrics/json", (req, res) => metricsController.getMetricsJson(req, res));
  router.get("/metrics/dashboard", (req, res) => metricsController.getDashboard(req, res));
